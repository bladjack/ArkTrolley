...
{
	public class MyRecipeDetailModel
	{
	...
	public class MyRecipeDetailResponseData
	{
		public string int_id { get; set; }
		...
		public List<MyRecipeDetailModel> arr_items { get; set; }
	}
	...
	public class MyRecipeDetailResponse
	{
		...
		public MyRecipeDetailResponseData responseData { get; set; }
	}
}
