...
namespace ArkTrolley.WebService
{
	...
	public class MyTicketDetailModelResponseData
	{
		public string int_id { get; set; }
		...
		public List<MyTicketDetailModel> arr_items { get; set; }
	}
	...
	public class MyTicketDetailResponse
	{
		...
		public MyTicketDetailModelResponseData responseData { get; set; }
	}
}
